...
export interface IStorage {
  ...
  cancelAndRefundAppointment(aptId: string, refundedBy: string, refundAmount?: number, cancelAppointment?: boolean): Promise<{ refundedAmount: string; patientName: string }>;
