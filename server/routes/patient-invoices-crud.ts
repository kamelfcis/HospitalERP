/*
 * ═══════════════════════════════════════════════════════════════════════════════
 *  Patient Invoices — CRUD Routes
 *  GET next-number | list | get-by-id | POST create | PUT update | header-discount
 * ═══════════════════════════════════════════════════════════════════════════════
 */
...
// ── Shared helpers (exported for use in other route sub-files) ────────────────
