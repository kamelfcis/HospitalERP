...
export const NAV_GROUPS: NavGroup[] = [
  ...
  // ── 5. المستشفى والمرضى ──────────────────────────────────────────────────
  {
    ...
    icon: Heart,
    items: [
      { title: "الاستقبال",               href: "/reception",           icon: ClipboardList, permission: "reception.view",         hospitalOnly: true },
      ...
      { title: "لوحة الأسرّة",            href: "/bed-board",            icon: BedDouble,     permission: "bed_board.view",          hospitalOnly: true },
      { title: "إدارة الأدوار والغرف",    href: "/room-management",      icon: DoorOpen,      permission: "rooms.manage",            hospitalOnly: true },
      { title: "أنواع العمليات الجراحية", href: "/surgery-types",        icon: Scissors,      permission: "surgery_types.manage",    hospitalOnly: true },
