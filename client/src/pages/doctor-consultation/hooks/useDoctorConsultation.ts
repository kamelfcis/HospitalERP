  ...
  const saveMutation = useMutation({
    mutationFn: (data: Consultation) => {
      ...
      return apiRequest("POST", "/api/clinic-consultations", {
        ...
        notes: data.notes,
        subjectiveSummary: data.subjectiveSummary || null,
        objectiveSummary: data.objectiveSummary || null,
  ...
  const finishConsultation = useCallback(async () => {
    ...
    try {
      await apiRequest("POST", "/api/clinic-consultations", {
        ...
        notes: form.notes,
        subjectiveSummary: form.subjectiveSummary || null,
        objectiveSummary: form.objectiveSummary || null,
        assessmentSummary: form.assessmentSummary || null,
