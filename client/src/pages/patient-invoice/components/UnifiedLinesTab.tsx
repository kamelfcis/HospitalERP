          ...
          <tbody>
            {lines.map((line, i) => {
              ...
              return (
                <tr
                  key={line.tempId}
                  className={`peachtree-grid-row ${isService ? getServiceRowClass(line.serviceType) : ""} ${isAutoLine ? "bg-sky-50/50 dark:bg-sky-950/20" : ""} ${isOversellNoStock ? "bg-orange-50 dark:bg-orange-950/20 border-r-2 border-r-orange-400" : ""}`}
