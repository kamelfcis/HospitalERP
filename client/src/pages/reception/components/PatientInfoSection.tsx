...
import type { PatientSuggest, DuplicateCandidate } from "./types";
import { SectionLabel } from "./types";


export const CandidateList = memo(function CandidateList({ candidates, onSelect }: { candidates: DuplicateCandidate[]; onSelect: (p: PatientSuggest) => void }) {
  return (
...
interface PatientInfoSectionProps {
  ...
  setHighlightedIdx: (v: number | ((prev: number) => number)) => void;
  ...
  quadNameRequired: boolean;
  requiresFullId: boolean;
  nidRequired: boolean;
}

export function PatientInfoSection({
  fullName, setFullName, phone, setPhone,
  nationalId, setNationalId, dateOfBirth, setDateOfBirth, age, setAge,
  existingPatient, showSuggestList, setShowSuggestions,
  highlightedIdx, setHighlightedIdx,
  patientSuggestions, handleSelectExistingPatient, handleClearExistingPatient,
  handleNameKeyDown, nameInputRef, phoneInputRef, suggestItemsRef,
  quadNameRequired, requiresFullId, nidRequired,
