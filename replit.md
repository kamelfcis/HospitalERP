...
- **Cashier & Security**: Real-time SSE for invoice visibility, password-protected cash drawers, department-level invoice isolation, separated two-journal system for sales (Phase 4: independent sales journal + independent cashier collection journal), and robust Role-Based Access Control (RBAC).
