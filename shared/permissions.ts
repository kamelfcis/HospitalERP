export const PERMISSIONS = {
  ...
  CASH_TRANSFER_VIEW:   "cash_transfer.view",
  CASH_TRANSFER_CREATE: "cash_transfer.create",
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, string[]> = {
  owner: [
    ...
    PERMISSIONS.CASH_TRANSFER_VIEW,
    PERMISSIONS.CASH_TRANSFER_CREATE,
...
export const PERMISSION_GROUPS: { label: string; permissions: { key: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: PERMISSIONS.CASH_TRANSFER_VIEW,   label: "عرض تحويلات النقدية" },
      { key: PERMISSIONS.CASH_TRANSFER_CREATE, label: "إنشاء تحويل نقدية" },
    ],
  },
  {
